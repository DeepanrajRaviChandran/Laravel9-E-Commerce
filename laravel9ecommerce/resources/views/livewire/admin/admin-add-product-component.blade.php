    ...
    <div class="page-header breadcrumb-wrap">
      <div class="container">
        <div class="breadcrumb">
          ...
          <span></span> Admin (Add New Product)
        </div>
      </div>
    </div>
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-6"> <a href="{{ route('admin.products') }}" class="btn btn-success float-end">All
                      Products</a></div>
                </div>
              </div>
              <div class="card-body">
                ...
                <form wire:submit.prevent="addProduct">
                  ...
                  <div class="mb-3 mt-3">
                    ...
                    <textarea name="short_description" class="form-control" placeholder="Enter Short Description"
