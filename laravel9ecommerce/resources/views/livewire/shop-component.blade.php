                ...
                <div class="sort-by-cover mr-10">
                  ...
                  <div class="sort-by-dropdown">
                    <ul>
                      ...
                      <li><a class="{{ $pageSize == 35 ? 'active' : '' }}" href="#"
                  ...
                  <div class="sort-by-dropdown">
                    <ul>
                      <li><a class="{{ $orderBy == 'Default Sorting' ? 'active' : '' }}" href="#"
                          wire:click.prevent="changeOrderBy('Default Sorting')">Default Sorting</a>
                      </li>
                      ...
                      <li><a class="{{ $orderBy == 'Price: High to Low' ? 'active' : '' }}" href="#"
                          ...
                          Low</a></li>
                      <li><a class="{{ $orderBy == 'Newest Products' ? 'active' : '' }}" href="#"
                          wire:click.prevent="changeOrderBy('Newest Products')">Newest Products</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="product-cart-wrap mb-30">
                    <div class="product-img-action-wrap">
                      <div class="product-img product-img-zoom">
                        <a href="{{ route('product.details', ['slug' => $product->slug]) }}">
                          ...
                          <img class="hover-img" src="{{ asset('assets/imgs/products') }}/{{ $product->image }}"
                            width="280" height="280" alt="{{ $product->name }}">
                        </a>
                      </div>
                    ...
                    <div class="product-content-wrap">
                      ...
                      <div class="product-price">
                        <span>RM{{ $product->regular_price }} </span>
                ...
                <div class="price-filter-inner">
                  ...
                  <div class="price_slider_amount">
                    <div class="label-input">
                      <span>Range:</span><span class="text-info">RM{{ $min_value }}</span> - <span
                        class="text-info">RM{{ $max_value }}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              @foreach ($nproducts as $nproduct)
                <div class="single-post clearfix">
                  ...
                  <div class="content pt-10">
                    ...
                    <p class="price mb-0 mt-5">RM{{ $nproduct->regular_price }}</p>
