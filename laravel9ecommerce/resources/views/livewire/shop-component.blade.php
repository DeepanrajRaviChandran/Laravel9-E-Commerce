                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy == 'Price: High to Low' ? 'active' : '' }}"
                                                    ...
                                                    to
                                                    Low</a></li>
                                            <li><a class="{{ $orderBy == 'Newest Products' ? 'active' : '' }}"
                                                    href="#"
                                                    wire:click.prevent="changeOrderBy('Newest Products')">Newest
                                                    Products</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span><span class="text-info">RM{{ $min_value }}</span> -
                                            <span class="text-info">RM{{ $max_value }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
