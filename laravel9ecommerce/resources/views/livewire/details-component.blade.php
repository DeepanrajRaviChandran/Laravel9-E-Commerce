                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="detail-gallery">
                    ...
                    <div class="slider-nav-thumbnails pl-15 pr-15">
                      <div><img src="{{ asset('assets/imgs/products') }}/{{ $product->image }}" alt="product image">
                      </div>
                      <div><img src="{{ asset('assets/imgs/products') }}/{{ $product->image }}" alt="product image">
                      </div>
                    </div>
                  ...
                  <div class="detail-info">
                    ...
                    <div class="clearfix product-price-cover">
                      <div class="product-price primary-color float-left">
                        <ins><span class="text-brand">RM{{ $product->regular_price }}</span></ins>
                        ...
                        <div class="product-cart-wrap small hover-up">
                            ...
                            <div class="product-img product-img-zoom">
                              <a href="{{ route('product.details', ['slug' => $rproduct->slug]) }}" tabindex="0">
                                <img class="default-img"
                                  ...
                                  alt="{{ $rproduct->name }}">
                                <img class="hover-img"
                                  src="{{ asset('assets/imgs/products') }}/{{ $rproduct->image }}" alt="">
                              </a>
                            </div>
                          ...
                          <div class="product-content-wrap">
                            ...
                            <div class="product-price">
                              <span>RM{{ $rproduct->regular_price }} </span>
