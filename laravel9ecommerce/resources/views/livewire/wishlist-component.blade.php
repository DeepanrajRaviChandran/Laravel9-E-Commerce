              ...
              <div class="product-cart-wrap mb-30">
                  ...
                  <div class="product-img product-img-zoom">
                    <a href="{{ route('product.details', ['slug' => $item->model->slug]) }}">
                      <img class="default-img"
                        ...
                        alt="{{ $item->model->name }}">
                      <img class="hover-img" src="{{ asset('assets/imgs/shop/product-') }}{{ $item->model->id }}-2.jpg"
                        alt="{{ $item->model->name }}">
                    </a>
                  </div>
                ...
                <div class="product-content-wrap">
                  ...
                  <div class="product-price">
                    <span>RM{{ $item->model->regular_price }} </span>
                    {{-- <span class="old-price">$245.8</span> --}}
                  </div>
                  <div class="product-action-1 show">
                    <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#"
                      wire:click.prevent="removeFromWishlist({{ $item->model->id }})"><i class="fi-rs-heart"></i></a>
                  </div>
                </div>
              </div>
            </div>
